...
I decided to build this project during my third year after taking the Object-Oriented Java Programming subject, I wanted to build something interesting with Java to practice and see what I could do on my own.
